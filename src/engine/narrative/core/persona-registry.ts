...
export function getRoleForTask(taskType: string): AgentRole {
  const companionTasks = ['dialogue', 'exam-dialogue', 'diary', 'farewell-letter', 'status-mood', 'test-thinking', 'midterm-thinking', 'test3-thinking', 'test3-companion-turn', 'event-dialogue', 'event-response', 'event-response-action', 'event-action', 'memory-consolidation'];
